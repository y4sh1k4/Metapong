      ...
      <div className="max-w-7xl mx-auto px-4 py-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex-shrink-0 bg-transparent">
            <Image src={'/logo2.png'} width={100} height={100} alt='logo'></Image>
          </div>
        ...
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            <a href="#home" className="block text-gray-300 hover:text-[#7FB9B9] transition-colors py-2">
              Home
            </a>
            <a href="#how-it-works" className="block text-gray-300 hover:text-[#7FB9B9] transition-colors py-2">
              How It Works
            </a>
            <a href="#rewards" className="block text-gray-300 hover:text-[#7FB9B9] transition-colors py-2">
              Rewards
            </a>
            <a href="#faq" className="block text-gray-300 hover:text-[#7FB9B9] transition-colors py-2">
              FAQ
            </a>
            <button className="w-full text-center px-4 py-2 rounded-full bg-[#7FB9B9] text-white hover:bg-opacity-80 transition-colors">
              Play Now
            </button>
          </div>
        </div>
